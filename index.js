  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center text-center w-full h-96 bg-pink-50 p-10">
        ...
        <h1 className="w-full h-1/4 text-pink-300 font-bold text-6xl uppercase">ur life</h1>
      </div>
      ...
      <div className="flex flex-row justify-around items-center text-center w-full h-96 bg-pink-50 px-5 pt-5">
        <h1 className='w-2/3 text-pink-400 font-bold text-6xl'>If I&apos;m C would you be my C++ to my life?</h1>
      </div>
